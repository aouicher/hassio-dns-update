# Home Assistant Add-on: Route53 uopdate with local IP
...
# Table of Contents
- [Home Assistant Add-on: Route53 uopdate with local IP](#home-assistant-add-on-route53-uopdate-with-local-ip)
